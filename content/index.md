...
logo: /images/file_00000000dfc8720a921b62f6f6818c4f (1).png
hero:
...
sections:
  - title: Un Savoir-Faire Forgé par le Temps
    paragraph1: Formé au sein de la prestigieuse Maison **Van Cleef & Arpels**,
  ...
  - title: L'Essence du Sur-Mesure
    paragraph1: Désormais, Vincent déploie cette exigence d'excellence dans
      l'univers de la joaillerie et des pièces personnalisées.
  ...
  - title: L'Élégance pour votre fidèle compagnon
    ...
    paragraph2: Qu'il s'agisse de colliers ou de médailles, chaque pièce est
  ...
  steps:
    ...
    - title: 2. Le Croquis & Les Gemmes
      description: Vincent vous propose des esquisses et une sélection de pierres
        précieuses ou fines adaptées à votre idée.
    - title: 3. La Création
      description: Votre bijou est façonné à la main, avec un soin méticuleux, dans le
        respect des traditions lapidaires.
footer_cta:
